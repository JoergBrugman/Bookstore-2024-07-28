codeunit 50102 "BSB Notif. Subscriber Store"
{
    ...
    var
        NotificationTxt: Label 'Customer balace exeeds credit limit';
        NotificationDescTxt: Label 'Balance of customer is lager than credit limit';
    begin
        MyNotifications.InsertDefaultWithTableNum(CredLimitNotifIDTxt, NotificationTxt, NotificationDescTxt, Database::Customer);
    end;
